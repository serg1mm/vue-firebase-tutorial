            ...
            <v-card hover>
                ...
                <v-card-text>
                    <div class="editprofile">
                        ...
                        <v-select autocomplete label="Country" placeholder="Select..." :rules="[() => !!country || 'This field is required']" :items="countries" v-model="country" ref="country" required></v-select>
                        <v-text-field label="E-mail" v-model="email" color="cyan" disabled></v-text-field>
                    </div>
                </v-card-text>
                <v-card-actions>
